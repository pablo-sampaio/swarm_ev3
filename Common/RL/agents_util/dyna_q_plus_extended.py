...
class DynaQPlusAgentExtended(object):
    def __init__(self, epsilon=0.1, gamma=0.98, alpha=0.1, planning_steps=5, kappa=0.00001, 
            default_q=0.0, auto_reverse_actions=True, epsilon_decay_fn=None):
        '''
        Parameters:
        ...
        - auto_reverse_actions: if True, then the agent will learn the reverse actions in its internal model (e.g., if turns CW, it will also learn the reverse transition with CCW)
        ...
        self.reverse_actions = auto_reverse_actions
