...
agent_parameters = {  
    ...
    "planning_steps" : 70,
    "kappa" : 0.0,
    "model_option" : 'transition', # TODO: consertar 'all' # TODO: fazer uma DFS ?
    "default_q" : 0.0,
    "initial_policy" : ['e-greedy', 'cell-count', 'state-action-count'] # 'state-count', 
}
...
plot_results_per_step(results_filename2, 'Results for initial policies', 'finished_episodes', "Finished\nepisodes")
